...
var isLoading = useFlightStore(function(s) { return s.isLoading; });
var error = useFlightStore(function(s) { return s.error; });
var count = useFlightStore(function(s) { return s.flights.length; });
var source = useFlightStore(function(s) { return s.lastSource; });
  ...
  <div className="w-screen h-screen overflow-hidden bg-globe-bg">
    ...
    <div className="fixed bottom-4 left-4 z-40 glass rounded-lg px-3 py-1.5">
      <p className="text-[10px] text-gray-500">
        Data: adsb.lol | Updates every 15s | Click a flight for details
      </p>
    </div>
  </div>
);
